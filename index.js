/* jslint node: true, latedef:false */
'use strict';
...
var SERVER = process.env.GNATSD || 'gnatsd';
...
function startServer(port, optFlags) {

  return new Promise(function(resolve, reject) {

    var server = spawnServer(port, optFlags, function(err) {
...
function spawnServer(port, optFlags, done) {
  if (!port) {
    port = DEFAULT_PORT;
  }
